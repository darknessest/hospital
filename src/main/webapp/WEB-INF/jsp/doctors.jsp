                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
                            <font size="4">医生管理</font>
                            <a href="<%=basePath%>showdoctors.hp">
                                <span class="glyphicon glyphicon-repeat"></span>
                            </a>
                            <span style="float: right">
									<button type="button" class="btn btn-default btn-sm"
                                            data-toggle="modal" data-target="#myModal" onclick="editInfo(this,0)">
										<span class="glyphicon glyphicon-plane"></span> 添加医师
									</button>
								</span>
                        </div>
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <form action="" method="post" role="form" id="editForm">
                                        <input type="hidden" id="dId" name="dId" class="form-control">
                                        <div class="form-group">
                                            <table class="table" style="font: '黑体';">
                                                ...
                                                <tr>
                                                    <td><b>医师类别:</b></td>
                                                    <td><input type="text" id="dType" name="dType" class="form-control"/></td>
                                                </tr>
                                                <tr>
                                                    <td><b>医师简述:</b></td>
                                                    <td><input type="text" id="dDesc" name="dDesc" class="form-control"/></td>
                                                </tr>
                                                <tr>
                                                    <td><b>医师联系方式:</b></td>
                                                    <td><input type="text" id="dPhone" name="dPhone" class="form-control"/></td>
                                                </tr>
                                                <tr>
                                                    <td><b>医师所属诊室：</b></td>
                                                    <td><input type="number" id="dRid" name="dRid" step="1" min="1"
                                                               max="999" class="form-control"/></td>
                                                </tr>
                                                </tbody>
                                            </table>
...
<script type="text/javascript">
    function editInfo(obj,flag){
        if(flag==0){
            ...
            $("#editForm").attr("action","<%=basePath%>adddoctors.hp");
        }else{
            $("#editForm").attr("action","<%=basePath%>modifydoctors.hp");
            var doctorsInfo = obj.parentNode.parentNode.childNodes;
            console.log(doctorsInfo);
            $("#dId").val(doctorsInfo[1].innerHTML);
