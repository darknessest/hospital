...
<%--    <jsp:include page="/js/jquery-1.10.2.js"></jsp:include>--%>
                                    ...
                                    <c:if test="${not empty list }">
                                        <c:forEach var="order" items="${list }">
                                            <tr>
                                                ...
                                                <td>${order.o_price }</td>
                                                <td><a id="pay" href="#" data-toggle="modal" data-target="#modalPay"
                                                       onclick="getPaymentLink(this)">
...
<script type="text/javascript">
    function getPaymentLink(obj) {
        $("#editForm").attr("action", "<%=basePath%>pay-order");
