...
<div id="login-page">
    <div class="container">
        <form class="form-login" action="hplogin" method="post">
            <h2 class="form-login-heading">医院预约后台管理系统</h2>
            <div class="login-wrap"><!-- required 必填， autofocus 光标锁定-->
                <input type="text" class="form-control" placeholder="请输入医院管理员账号" name="hAccount" required autofocus>
                <br>
                <input type="password" class="form-control" placeholder="请输入医院管理员密码" name="hPassword" required>
                <br>
